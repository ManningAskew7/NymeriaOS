...
export interface Message {
  ...
  // renderer must not label them all as a model switch.
  noteKind?: 'transport' | 'refusal' | 'destination';
  content: string;
...
export interface ServerSettingsUpdate {
  ...
  dropbox_api_base_url?: string | null;
  dropbox_content_base_url?: string | null;
  nextcloud_webdav_url?: string | null;
  nextcloud_username?: string | null;
  nextcloud_password?: string | null;
  nextcloud_access_token?: string | null;
  ...
  clearbit_company_base_url?: string | null;
  clearbit_person_base_url?: string | null;
  clearbit_autocomplete_base_url?: string | null;
  uplead_api_key?: string | null;
  uplead_base_url?: string | null;
  dropcontact_api_key?: string | null;
  dropcontact_base_url?: string | null;
  humantic_api_key?: string | null;
  humantic_base_url?: string | null;
  lonescale_api_key?: string | null;
  lonescale_base_url?: string | null;
  uproc_email?: string | null;
  uproc_api_key?: string | null;
  uproc_base_url?: string | null;
  ...
  teams_bot_respond_mode?: string | null;
  teams_bot_validate_auth?: boolean | null;
...
export interface UnifiedTool {
  ...
  enabled: boolean;
  // Backend currently always emits the literal "default_thread_tools" here;
  // informational only, not branched on by the UI.
...
// ui_prompt SSE event, emitted by the agent's ui_prompt tool. Desktop-only
// renderer for now: mobile ignores the event (no autonomous-store case) but
// mirrors the wire types and API method for future parity.
...
export interface UiPromptEvent {
  ...
  title: string;
  /** Agent-authored HTML fragment, rendered ONLY inside a sandboxed iframe. */
  html: string;
  timeout_seconds: number;
 ...
 * The legal-action-per-event map and category taxonomy live in
 * `$lib/utils/hooks`.
 */
