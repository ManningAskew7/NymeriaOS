...
class InProcessInstagramAPI:
    """Nymeria API adapter used by the API-hosted Instagram webhook client."""
    ...
    async def _chat_stream(self, message: str, thread_id: str, user_id: str):
        ...
        try:
            ...
            logger.debug("Instagram done metadata failed", exc_info=True)
        try:
            ...
            logger.debug("Instagram auto-title failed", exc_info=True)
        yield done
    ...
    def _publish_platform_sync(self, thread_id: str, user_id: str) -> None:
        try:
            ...
            logger.debug("Instagram platform sync publish failed", exc_info=True)
