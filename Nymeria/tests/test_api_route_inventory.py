...
EXPECTED_ROUTES = [
    ...
    ('/browser-login/sessions', ('GET',)),
    ('/browser-login/{session_id}/end', ('POST',)),
    ('/browser-login/{session_id}/frame', ('POST',)),
    ('/browser-login/{session_id}/input', ('POST',)),
    ('/browser-login/{session_id}/stream', ('GET',)),
    ('/chat', ('POST',)),
    ('/chat/sync', ('POST',)),
